                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">Create Mill Order <span class="pull-right"></span></h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3">Order quantity <span class="text-danger">*</span></label>
											...
											<div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3">Order date<span class="text-danger">*</span></label>

                                                    <div class="col-md-9">

                                                        <input type="number" class="form-control sphone" placeholder="Please Enter date..." name="sphone">
											...
											<div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3">Mill Id<span class="text-danger">*</span></label>

                                                    <div class="col-md-9">

                                                        <input type="number" class="form-control sphone" placeholder="Please Enter Mill id..." name="sphone">
