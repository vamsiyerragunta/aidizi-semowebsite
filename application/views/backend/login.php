...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url(); ?>assets/images/background/JuteMillBackground.jpg);">
        <div class="login-box card" style="border-radius: 20px;">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/signIn">
                    ...
                    <img src="<?php echo base_url(); ?>assets/images/JuteMillLogo.png" alt="Home" height="100" /></a>
