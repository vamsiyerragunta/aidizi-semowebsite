                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">Add Jute Mill <span class="pull-right"></span></h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3">JuteMill_id<span class="text-danger">*</span></label>

                                                    <div class="col-md-9">

                                                        <input type="text" class="form-control sname" name="sname" placeholder="please enter id..." required>
											...
											<div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3">Jute mill name<span class="text-danger">*</span></label>

                                                    <div class="col-md-9">

                                                        <input type="number" class="form-control sphone" placeholder="please enter name..." name="sphone">
											...
											<div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="number" class="form-control sphone" placeholder="Please Enter address..." name="sphone">
											...
											<div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="number" class="form-control sphone" placeholder="Please Enter contact number..." name="sphone">
											...
											<div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3">Mail <span class="text-danger">*</span></label>

                                                    <div class="col-md-9">

                                                        <input type="number" class="form-control sphone" placeholder="Please Enter mail id..." name="sphone">
