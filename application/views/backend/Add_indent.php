                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">Create Indent <span class="pull-right"></span></h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3">SPA Name <span class="text-danger">*</span></label>

                                                    <div class="col-md-9">

                                                        <input type="text" class="form-control sname" name="sname" placeholder="State Foodgrain Procurement Agency Name..." required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3">Indent Number <span class="text-danger">*</span></label>
											...
											<div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Indent Qty</label>
                                                    <div class="col-md-9">
                                                        <input type="text" name="saddress" class="form-control saddress" placeholder="">
                                                    </div>
                                                </div>
                                            </div>                                            
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="row justify-content-md-center">
                                            ...
                                            <div class=" col-md-offset-2 col-md-1 ">
                                                ...
                                                <button type="submit" class="btn btn-info"><a href="<?php echo base_url(); ?>Jutecommissioner/manageIndent">Submit</a></button>
